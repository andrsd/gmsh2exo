...
option(GMSH2EXO_CODE_COVERAGE "Builds targets with code coverage instrumentation" OFF)

if(GMSH2EXO_CODE_COVERAGE)
    ...
    if(CMAKE_C_COMPILER_ID MATCHES "(Apple)?[Cc]lang" OR CMAKE_CXX_COMPILER_ID MATCHES "(Apple)?[Cc]lang")
        ...
        set(CODE_COVERAGE_PROFRAWS
            ${CMAKE_BINARY_DIR}/test/2blk-test.profraw
            ${CMAKE_BINARY_DIR}/test/square-test.profraw
            ${CMAKE_BINARY_DIR}/test/cube-2x2x2-test.profraw
        )
        ...
        set(EXCLUDE_REGEX
            ...
            --ignore-filename-regex=exodusIIcpp/*
            --ignore-filename-regex=gmshparsercpp/*
        )
